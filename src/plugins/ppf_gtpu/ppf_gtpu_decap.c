...
static u8 * format_ppf_gtpu_rx_trace (u8 * s, va_list * args)
{
             ...
             u32 is_ip4)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  uword * ppf_p0, *ppf_p1;
          ...
          u32 ppf_tunnel_index0, ppf_tunnel_index1;
          ppf_gtpu_tunnel_t * t0, * t1, * mt0 = NULL, * mt1 = NULL;
          ppf_gtpu4_tunnel_key_t key4_0, key4_1;
          ppf_gtpu4_tunnel_key_t ppf_key4_0, ppf_key4_1;
	...
	next0:
	  ...
	  vlib_buffer_advance (b0, ppf_gtpu_hdr_len0);
          ...
          vnet_buffer(b0)->sw_if_index[VLIB_TX] = ppf_tunnel_index0;
	  ...
	  if (PREDICT_FALSE (sw_if_index0 != stats_sw_if_index))
        ...
        trace0:
          ...
          if (PREDICT_FALSE ((ppf_gtpu1->ver_flags & PPF_GTPU_VER_MASK) != PPF_GTPU_V1_VER))
	    {
	...
	next1:
	  ...
	  vlib_buffer_advance (b1, ppf_gtpu_hdr_len1);
          ...
          /* Set packet input sw_if_index to unicast PPF_GTPU tunnel for learning */
          vnet_buffer(b1)->sw_if_index[VLIB_TX] = ppf_tunnel_index1;
      ...
      while (n_left_from > 0 && n_left_to_next > 0)
	{
	  ...
	  uword * ppf_p0;
          u32 tunnel_index0;
          u32 ppf_tunnel_index0;
          ppf_gtpu_tunnel_t * t0,* mt0 = NULL;
          ppf_gtpu4_tunnel_key_t key4_0, ppf_key4_0;
  ...
  vlib_node_increment_counter (vm, is_ip4?
			       ppf_gtpu4_input_node.index:ppf_gtpu6_input_node.index,
...
VLIB_REGISTER_NODE (ppf_gtpu4_input_node) = {
  .function = ppf_gtpu4_input,
  .name = "ppf_gtpu4-input",
  /* Takes a vector of packets. */
  .vector_size = sizeof (u32),

  .n_errors = PPF_GTPU_N_ERROR,
  .error_strings = ppf_gtpu_error_strings,

  .n_next_nodes = PPF_GTPU_INPUT_N_NEXT,
  .next_nodes = {
...
VLIB_REGISTER_NODE (ppf_gtpu6_input_node) = {
  .function = ppf_gtpu6_input,
  .name = "ppf_gtpu6-input",
  /* Takes a vector of packets. */
  .vector_size = sizeof (u32),
...
VLIB_REGISTER_NODE (ip4_ppf_gtpu_bypass_node) = {
  .function = ip4_ppf_gtpu_bypass,
  .name = "ip4-ppf_gtpu-bypass",
  .vector_size = sizeof (u32),

  .n_next_nodes = IP_PPF_GTPU_BYPASS_N_NEXT,
  .next_nodes = {
...
VLIB_REGISTER_NODE (ip6_ppf_gtpu_bypass_node) = {
  .function = ip6_ppf_gtpu_bypass,
  .name = "ip6-ppf_gtpu-bypass",
  .vector_size = sizeof (u32),
