...
/* error no definition */
/*
ERROR_1 VNET_API_ERROR_WRONG_MAX_SESSION_NUM, -200, "Wrong max session number")              \
ERROR_2 VNET_API_ERROR_CALLLNE_IN_USE, -201, "Calline is not empty")                         \
ERROR_3 VNET_API_ERROR_EMPTY_CALLINE, -202, "Calline is empty")                              \
ERROR_4 VNET_API_ERROR_WRONG_TUNNEL_TYPE, -203, "Tunnel type is wrong")                      \
ERROR_5 VNET_API_ERROR_TUNNEL_IN_USE, -204, "tunnel is not empty")                           \
ERROR_6 VNET_API_ERROR_TUNNEL_IS_EMPTY, -205, "tunnel is not existed")                       \
ERROR_7 VNET_API_ERROR_UPDATE_TUNNEL_WRONG_IP, -206, "wrong ip type for src and dst")        \
*/
